...
// base: '/' 必须使用绝对路径。原因：前端没有路由库，靠 location.pathname 区分
// /、/admin、/admin/console 等页面。若用相对路径 './'，在 /admin/console 深层路径下
// 资源会被解析成 /admin/assets/... 而 404，导致 JS 不执行、页面空白。
// 用 '/' 后资源恒为 /assets/...，任何路径层级都能正确加载。
